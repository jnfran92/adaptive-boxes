...
print('Work Finished!!!')
print('Creating args elapsed time: ' + str(end_args - start_args))
...
#
# # Plot the rectangles
# def plot_rectangles(recs_arg: List[Rectangle]):
#     plt.figure()
#     sep_to_plot = sep_value / 2
#     for rec_val in recs_arg:
#         p1 = np.array([rec_val.x1 - sep_to_plot, rec_val.y1 - sep_to_plot])
#         p2 = np.array([rec_val.x1 - sep_to_plot, rec_val.y2 + sep_to_plot])
#         p3 = np.array([rec_val.x2 + sep_to_plot, rec_val.y1 - sep_to_plot])
#         p4 = np.array([rec_val.x2 + sep_to_plot, rec_val.y2 + sep_to_plot])
#
#         ps = np.array([p1, p2, p4, p3, p1])
#         plt.plot(ps[:, 0], ps[:, 1])
#
...
# plt.figure()
# sep_to_plot = sep_value / 2
# p1 = np.array([rec.x1 - sep_to_plot, rec.y1 - sep_to_plot])
# p2 = np.array([rec.x1 - sep_to_plot, rec.y2 + sep_to_plot])
# p3 = np.array([rec.x2 + sep_to_plot, rec.y1 - sep_to_plot])
# p4 = np.array([rec.x2 + sep_to_plot, rec.y2 + sep_to_plot])
#
# ps = np.array([p1, p2, p4, p3, p1])
# plt.plot(ps[:, 0], ps[:, 1])
...
#
#
# # Write condition on Global Data
# condition = ((data_2d_global[:, 0] >= x1) & (data_2d_global[:, 0] <= x2)) & (
#         (data_2d_global[:, 1] >= y1) & (data_2d_global[:, 1] <= y2))
